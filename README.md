...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-05 02:44`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/619e9f6b-c331-4e9f-b44d-5b7a73d417de.git
$ cd 619e9f6b-c331-4e9f-b44d-5b7a73d417de
```
